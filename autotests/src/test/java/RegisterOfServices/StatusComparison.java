...
public class StatusComparison extends BaseClass {
    ...
    public void checkStatus81() throws Exception {
        assertEquals(getNumbersFromTable("//ul/li[8]/div/div[2]").size(),
                getCountStatus(81)
        );
    }
    ...
    public void checkStatus122() throws Exception {
        assertEquals(getNumbersFromTable("//ul/li[7]/div/div[2]").size(),
                getCountStatus(122)
        );
    }
    ...
    public void checkStatus121() throws Exception {
        assertEquals(getNumbersFromTable("//ul/li[6]/div/div[2]").size(),
                getCountStatus(121)
        );
    }
    ...
    public void checkStatus82() throws Exception {
        assertEquals(getNumbersFromTable("//ul/li[5]/div/div[2]").size(),
                getCountStatus(82)
        );
    }
    ...
    public void checkStatus80() throws Exception {
        assertEquals(getNumbersFromTable("//ul/li[4]/div/div[2]").size(),
                    getCountStatus(80)
         );
    }
    ...
    public void checkStatus79() throws Exception {
        assertEquals(getNumbersFromTable("//ul/li[3]/div/div[2]").size(),
                    getCountStatus(79)
        );
    }
    ...
    public void checkStatus78() throws Exception {
        assertEquals(getNumbersFromTable("//ul/li[2]/div/div[2]").size(),
                getCountStatus(78)
        );
    }
    ...
    public void chekStatus77() throws Exception {
        assertEquals(getNumbersFromTable("//ul/li[1]/div/div[2]").size(),
                     getCountStatus(77)
        );
    }
